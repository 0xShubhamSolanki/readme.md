...
- 🔧 **MetaCall (Core Runtime)**
  - Fixed Node.js loader build issue on Ubuntu 24 (`libnode-dev`)
  - Improved build reliability (avoided unnecessary source builds)
  - Added reproducible test script
  - 🔗 https://github.com/metacall/core/pull/742
